...
def notclicki():
    w3=Toplevel()
    w3.title("Sustav Banke krvi")
    w3.geometry("600x600")
    w3.iconbitmap('krv.ico')
    w3['bg'] = '#9E5D5D'
    def zaposlenik_fnk():
                def connection(): 
                    conn=pymysql.connect(host='localhost',user='root',password='root',database="baza_banke_krvi")
    ...
    zaposlenik_txt = zaposlenik_create_txt = Label(w3, text = 'Podaci o zaposleniku').pack()
    zaposlenik_create_button = Button(w3, text = 'Zaposlenik CRUD', command=zaposlenik_fnk, fg = 'white', bg='blue', padx=15, pady=15, font='sans-serif').pack()
