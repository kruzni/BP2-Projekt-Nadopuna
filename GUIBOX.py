...
# ---------------------- login ----------------------------- #
login1 = Label(root, text = "Enter ID")
ID1 = StringVar()
enter_ID = Entry(root, textvariable=ID1)
...
def clicki():
    ...
    def w4_crud():
        ...
        def zaposlenik_crud():
            ...
            def zaposlenik_r():
                ...
                zaposlenik_read.iconbitmap('krv.ico')
            ...
            def zaposlenik_cr():
                ...
                zaposlenik_c.iconbitmap('krv.ico')
            #---UPDATE---#
            def zaposlenik_up():
                ...
                zaposlenik_u.iconbitmap('krv.ico')
        ...
        def darivatelj_rud():
            ...
            def darivatelj_r():
                ...
                darivatelj_read.iconbitmap('krv.ico')
            ...
            def darivatelj_u():
                ...
                darivatelj_u.iconbitmap('krv.ico')
    ...
    #-----BUTTONI ZA darivatelj_rud()------#
        ...
        def prijevoznik_crud():
            ...
            prijevoznik.iconbitmap('krv.ico')
            ...
            def prijevoz_r():
                ...
                prijevoznik_read.iconbitmap('krv.ico')
            #--CREATE---#
            def prijevoz_c():
                prijevoz_c = Toplevel()
    ...
    def w6_davanje_ovlasti():
        ...
        davanje_ovlasti.iconbitmap('krv.ico')
